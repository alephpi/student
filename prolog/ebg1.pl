...
:- dynamic partOf/2, hasWire/2, attached/2, feature/2, antenna/1, hasProtocol/2, rotaryDial/1, frequencyDial/1, touchScreen/1, hasSoftware/2, dialingSoftware/1, example/2, hasHP/1, known/1.
